...
2: {"s": [["श्रीभगवान्", "śrībhagavān", "the Blessed Lord"],
          ["उवाच", "uvāca", "said"]],
    0: [["सन्न्यासः", "sannyāsaḥ", "renunciation"],
        ["कर्मयोगः", "karmayogaḥ", "karma-yoga"],
        ["च", "ca", "and"]],
    1: [["निःश्रेयसकरौ", "niḥśreyasakarau", "leading to the highest good"],
        ["उभौ", "ubhau", "both"]],
    2: [["तयोः", "tayoḥ", "of the two"],
        ["तु", "tu", "but"],
        ["कर्मसन्न्यासात्", "karmasannyāsāt", "than the renunciation of action"]],
    3: [["कर्मयोगः", "karmayogaḥ", "karma-yoga"],
        ["विशिष्यते", "viśiṣyate", "excels"]]},

3: {"s": [],
    0: [["ज्ञेयः", "jñeyaḥ", "to be known"],
        ["सः", "saḥ", "he"],
    ...
    2: [["निर्द्वन्द्वः", "nirdvandvaḥ", "free from the pairs of opposites"],
        ["हि", "hi", "indeed"],
        ["महाबाहो", "mahābāho", "O mighty-armed one"]],
    3: [["सुखम्", "sukham", "easily"],
        ["बन्धात्", "bandhāt", "from bondage"],
        ["प्रमुच्यते", "pramucyate", "is released"]]},

4: {"s": [],
    0: [["साङ्ख्ययोगौ", "sāṅkhyayogau", "sāṅkhya and yoga"],
        ["पृथक्", "pṛthak", "as different"],
        ["बालाः", "bālāḥ", "the childish"]],
    1: [["प्रवदन्ति", "pravadanti", "declare"],
        ["न", "na", "not"],
        ["पण्डिताः", "paṇḍitāḥ", "the wise"]],
    2: [["एकम्", "ekam", "one"],
        ["अपि", "api", "even"],
        ["आस्थितः", "āsthitaḥ", "established in"],
        ["सम्यक्", "samyak", "rightly"]],
    3: [["उभयोः", "ubhayoḥ", "of both"],
        ["विन्दते", "vindate", "attains"],
...
6: {"s": [],
    0: [["सन्न्यासः", "sannyāsaḥ", "renunciation"],
        ["तु", "tu", "but"],
        ["महाबाहो", "mahābāho", "O mighty-armed one"]],
    1: [["दुःखम्", "duḥkham", "hard, difficult"],
        ["आप्तुम्", "āptum", "to attain"],
        ["अयोगतः", "ayogataḥ", "without yoga"]],
    2: [["योगयुक्तः", "yogayuktaḥ", "devoted to yoga"],
        ["मुनिः", "muniḥ", "the sage"],
        ["ब्रह्म", "brahma", "Brahman"]],
    3: [["नचिरेण", "nacireṇa", "before long"],
...
9: {"s": [],
    0: [["प्रलपन्", "pralapan", "speaking"],
        ["विसृजन्", "visṛjan", "giving up"],
        ["गृह्णन्", "gṛhṇan", "holding, taking"]],
    1: [["उन्मिषन्", "unmiṣan", "opening the eyes"],
        ["निमिषन्", "nimiṣan", "closing the eyes"],
        ["अपि", "api", "even"]],
    2: [["इन्द्रियाणि", "indriyāṇi", "the senses"],
        ["इन्द्रियार्थेषु", "indriyārtheṣu", "among the sense-objects"]],
    3: [["वर्तन्ते", "vartante", "move, act"],
        ["इति", "iti", "thus"],
...
12: {"s": [],
    0: [["युक्तः", "yuktaḥ", "the one established in yoga"],
        ["कर्मफलम्", "karmaphalam", "the fruit of action"],
        ["त्यक्त्वा", "tyaktvā", "having renounced"]],
    1: [["शान्तिम्", "śāntim", "peace"],
        ["आप्नोति", "āpnoti", "attains"],
        ["नैष्ठिकीम्", "naiṣṭhikīm", "abiding, lasting"]],
    2: [["अयुक्तः", "ayuktaḥ", "the one not established in yoga"],
        ["कामकारेण", "kāmakāreṇa", "by desire-driven impulse"]],
    3: [["फले", "phale", "to the fruit"],
        ["सक्तः", "saktaḥ", "attached"],
        ["निबध्यते", "nibadhyate", "is bound"]]},

13: {"s": [],
    0: [["सर्वकर्माणि", "sarvakarmāṇi", "all actions"],
        ["मनसा", "manasā", "in the mind"]],
    1: [["सन्न्यस्य", "sannyasya", "having renounced"],
        ["आस्ते", "āste", "dwells"],
        ["सुखम्", "sukham", "happily"],
        ["वशी", "vaśī", "the self-controlled one"]],
    2: [["नवद्वारे", "navadvāre", "in the nine-gated"],
        ["पुरे", "pure", "city"],
        ["देही", "dehī", "the embodied one"]],
    3: [["न", "na", "neither"],
        ["एव", "eva", "indeed"],
        ["कुर्वन्", "kurvan", "acting"],
        ["न", "na", "nor"],
        ["कारयन्", "kārayan", "causing to act"]]},
...
18: {"s": [],
    0: [["विद्या", "vidyā", "learning"],
        ["विनय", "vinaya", "and humility"],
        ["सम्पन्ने", "sampanne", "endowed with"]],
    1: [["ब्राह्मणे", "brāhmaṇe", "in a brāhmaṇa"],
        ["गवि", "gavi", "in a cow"],
        ["हस्तिनि", "hastini", "in an elephant"]],
    2: [["शुनि", "śuni", "in a dog"],
        ["च", "ca", "and"],
        ["एव", "eva", "even"],
        ["श्वपाके", "śvapāke", "in an outcaste"],
        ["च", "ca", "and"]],
    3: [["पण्डिताः", "paṇḍitāḥ", "the wise"],
        ["समदर्शिनः", "samadarśinaḥ", "of equal vision"]]},
...
25: {"s": [],
    0: [["लभन्ते", "labhante", "attain"],
        ["ब्रह्मनिर्वाणम्", "brahmanirvāṇam", "Brahman-nirvāṇa"]],
    1: [["ऋषयः", "ṛṣayaḥ", "the seers"],
        ["क्षीण", "kṣīṇa", "destroyed"],
        ["कल्मषाः", "kalmaṣāḥ", "whose sins"]],
    2: [["छिन्न", "chinna", "cut"],
        ["द्वैधाः", "dvaidhāḥ", "whose doubts"],
        ["यत", "yata", "controlled"],
        ["आत्मानः", "ātmānaḥ", "whose selves"]],
    3: [["सर्वभूतहिते", "sarvabhūtahite", "in the welfare of all beings"],
        ["रताः", "ratāḥ", "delighting"]]},

26: {"s": [],
    0: [["काम", "kāma", "of desire"],
        ["क्रोध", "krodha", "and anger"],
        ["वियुक्तानाम्", "viyuktānām", "of those free from"]],
    1: [["यतीनाम्", "yatīnām", "of the ascetics"],
        ["यत", "yata", "controlled"],
        ["चेतसाम्", "cetasām", "whose thoughts"]],
    2: [["अभितः", "abhitaḥ", "on every side"],
        ["ब्रह्मनिर्वाणम्", "brahmanirvāṇam", "Brahman-nirvāṇa"]],
    3: [["वर्तते", "vartate", "is present"],
...
28: {"s": [],
    0: [["यत", "yata", "controlled"],
        ["इन्द्रिय", "indriya", "senses"],
        ["मनः", "manaḥ", "mind"],
        ["बुद्धिः", "buddhiḥ", "intellect"]],
    1: [["मुनिः", "muniḥ", "the sage"],
        ["मोक्ष", "mokṣa", "of liberation"],
        ["परायणः", "parāyaṇaḥ", "intent on"]],
    2: [["विगत", "vigata", "gone, free from"],
        ["इच्छा", "icchā", "desire"],
        ["भय", "bhaya", "fear"],
